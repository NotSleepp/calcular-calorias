...
export default function ActivityList({ activities, dispatch }: ActivitiListProps) {
  ...
  return (
    <>
      ...
      { isEmptyActivities ? <p className="text-center">No hay actividades todavia... </p> : <h2 className="text-4xl font-bold text-slate-600 text-center">Comida y Actividades</h2> }
